...
drew_overview.html - HTML overview documentation file for the generated component. It 
                     contains the requirements for accessing the component and for 
                     generating arguments using the MWArray class hierarchy.

drew.xml - This file contains the code comments for the drew component classes and 
                     ...
                     online documentation for the drew component.
